            ...
            success:function(result){
                if(result['error_code']!='0')
                    ...
                    if(result['result']['user_list'][0]['score']>80) {
                        var loginname = result['result']['user_list'][0]['user_id'];
                        var pwd = result['result']['user_list'][0]['user_info'];
                        window.parent.location="user/login.do?loginName="+loginname+"&password="+pwd;
                    }else{
                        $.MsgBox.Alert("消息","登录失败");
                    }
                }
