        ...
        <div class="input_text">
            ...
            <div class="content">
                ...
                <div class="formitem">
                    ...
                    <span class="input">
					        		<input id="loginname" name="loginName" value="" class="form-control l35"
                                           fv_type="NOTCN" type="text" maxlength="20" placeholder="请输入您的用户名" value=""
                ...
                <div>
                    <button type="button" id="login-submit-btn" class="layui-btn  btn-login" style="width:150px">&nbsp;&nbsp;登　录&nbsp;&nbsp;</button>
                    <button type="button" title="刷脸登录" data-search-open="" data-title="刷脸登录" modal-toggle="modal"
                            data-href="face/toFaceLogin.do" data-width="780" data-height="500" class="layui-btn  btn-login"
                            style="width:150px">&nbsp;&nbsp;刷 脸&nbsp;&nbsp;
                    </button>
                </div>
