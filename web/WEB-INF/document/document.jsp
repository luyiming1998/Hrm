                ...
                if(checkedBoxs.length < 1){
                    ...
                    $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
                        if(r){
                            // alert("删除："+ids.get());
                            // 发送请求
                            window.location = "doc/doDelDocument.do?ids=" + ids.get();
                        }
                    });
                }
            })
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    ...
    <tr valign="top">
        <td height="30">
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                <tr>
                    <td class="fftd">
                    <form action="doc/toShowDocument.do" method="post">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="font3">
    ...
    <tr valign="top">
        <td height="20">
            <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
                ...
                <tr ondblclick="down(${doc.filename});" class="main_trbg" align="center" id="data_0" style="background-color: rgb(255, 255, 255);">
                    <td><input type="checkbox" id="box_0" value="${doc.id}"></td>
                    <td>${doc.title}</td>
                    <td>
                        <fmt:formatDate value="${doc.create_date}" pattern="yyyy年MM月dd日"/>
                    </td>
                    <td>${doc.user.username}</td>
                    <td>${doc.remark}</td>

                    <td align="center" width="40px;"><a href="doc/toShowUpdateDocument.do?id=${doc.id}">
                        <img title="修改" src="images/update.gif"></a>
                    </td>

                    <td align="center" width="40px;"><a href="doc/doDownload.do?fileName=${doc.filename}" id="down_${doc.filename}">
    ...
    <!-- 分页标签 -->
    <form action="doc/toShowDocument.do" method="post" id="pageForm">
