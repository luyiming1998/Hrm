...
function loadMenu(){
	...
	+'"childs": [{"id": "11","name": "用户管理","icon": "/xingxing.png","url": "user/toShowUser.do","parentId": "1",'
	+'"childs": [{"id": "111","name": "用户查询","icon": "","url": "user/toShowUser.do","parentId": "11",'
	+'"childs": []},{"id": "112","name": "添加用户","icon": "","url": "user/toShowAddUser.do","parentId": "11",'
	+'"childs": []}]},{"id": "12","name": "部门管理","icon": "/xingxing.png","url": "dept/toShowDept.do","parentId": "1",'
	+'"childs": [{"id": "121","name": "部门查询","icon": "","url": "dept/toShowDept.do","parentId": "12",'
	+'"childs": []},{"id": "122","name": "添加部门","icon": "","url": "dept/toShowAddDept.do","parentId": "12",'
	+'"childs": []}]},{"id": "14","name": "职位管理","icon": "/xingxing.png","url": "job/toShowJob.do","parentId": "1",'
	+'"childs": [{"id": "141","name": "职位查询","icon": "","url": "job/toShowJob.do","parentId": "14",'
	+'"childs": []},{"id": "142","name": "添加职位","icon": "","url": "job/toShowAddJob.do","parentId": "14",'
	+'"childs": []}]},{"id": "15","name": "员工管理","icon": "/xingxing.png","url": "emp/toShowEmployee.do","parentId": "1",'
	+'"childs": [{"id": "151","name": "员工查询","icon": "","url": "emp/toShowEmployee.do","parentId": "15",'
	+'"childs": []},{"id": "152","name": "添加员工","icon": "","url": "emp/toShowAddEmployee.do","parentId": "15",'
	+'"childs": []}]},{"id": "16","name": "公告管理","icon": "/xingxing.png","url": "notice/toShowNotice.do","parentId": "1",'
	+'"childs": [{"id": "161","name": "公告查询","icon": "","url": "notice/toShowNotice.do","parentId": "16",'
	+'"childs": []},{"id": "162","name": "添加公告","icon": "","url": "notice/toShowAddNotice.do","parentId": "16",'
	+'"childs": []}]},{"id": "17","name": "下载中心","icon": "/xingxing.png","url": "doc/toShowDocument.do","parentId": "1",'
	+'"childs": [{"id": "171","name": "文档查询","icon": "","url": "doc/toShowDocument.do","parentId": "17",'
	+'"childs": []},{"id": "172","name": "上传文档","icon": "","url": "doc/toShowAddDocument.do","parentId": "17","childs": []}]}]}]';
	// jquery的方法
