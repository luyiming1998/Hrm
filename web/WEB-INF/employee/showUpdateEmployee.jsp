            ...
            <table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
                <tbody><tr valign="top">
                    <td>
                        ...
                        <!-- 隐藏表单，flag表示添加标记 -->
                        <input type="hidden" name="flag" value="2">
                        <form id="employeeForm" action="emp/doUpdateEmployee.do" method="post">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                            ...
                            <tr>
                                <td class="font3 fftd">
                                    出生日期：<input cssclass="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy/MM/dd'});" name="birthday" id="birthday" size="40" value="<fmt:formatDate value="${employee.birthday}" pattern="yyyy/MM/dd"/>">&nbsp;&nbsp;
